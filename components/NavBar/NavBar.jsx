...
import { AiFillLock, AiFillUnlock } from "react-icons/ai";  // Corrected imports
...
const NavBar = () => {
  ...
  const openNavigation = () => {
    setOpenNav(prev => !prev);  // Simplified the toggle logic
  };
            ...
            <div>
              <div className={Style.connect_flex}>
                ...
                {currentAccount && (
                  <span>
                    {openNav ? (
                      <AiFillUnlock onClick={() => openNavigation()} /> // Fixed icon usage
                    ) : (
                      <AiFillLock onClick={() => openNavigation()} />  // Fixed icon usage
                    )}
                  </span>
                )}
              </div>
